...
var skel = (function() { var _ = {
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		css: {
			...
			gF: '.row.flush,.flush>.row{margin-left:0;}.row.flush>.\\31 u,.row.flush>.\\32 u,.row.flush>.\\33 u,.row.flush>.\\34 u,.row.flush>.\\35 u,.row.flush>.\\36 u,.row.flush>.\\37 u,.row.flush>.\\38 u,.row.flush>.\\39 u,.row.flush>.\\31 0u,.row.flush>.\\31 1u,.row.flush>.\\31 2u,.flush>.row>.\\31 u,.flush>.row>.\\32 u,.flush>.row>.\\33 u,.flush>.row>.\\34 u,.flush>.row>.\\35 u,.flush>.row>.\\36 u,.flush>.row>.\\37 u,.flush>.row>.\\38 u,.flush>.row>.\\39 u,.flush>.row>.\\31 0u,.flush>.row>.\\31 1u,.flush>.row>.\\31 2u{padding:0!important}',
