/* skelJS v0.3.1-dev | (c) n33 | n33.co @n33co | MIT + GPLv2 */
								...
								// Gutters
									...
									if (!(x = _.getCachedElement('iGG' + state.config.grid.gutters)))
										x = _.cacheElement( 
											...
											_.newInline('.\\31 u,.\\32 u,.\\33 u,.\\34 u,.\\35 u,.\\36 u,.\\37 u,.\\38 u,.\\39 u,.\\31 0u,.\\31 1u,.\\31 2u{padding:' + g + ' 0 0 '+ g + ';float:left}.row+.row>*{padding-top:' + g + '}.row{margin-left:-' + g + '}'), 
											'head', 
											3
										); 
